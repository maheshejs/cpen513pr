...
class AppTest {
    ...
    //       2 1 2         //
    /////////////////////////
    Benchmark    benchmark   = new Benchmark("example.txt", true);
    ...
    @Test void testLoc () {
        ...
        assertEquals(benchmark.getLoc(0), new Point2D(0.0, 0.0));
        assertEquals(benchmark.getLoc(1), new Point2D(1.0, 0.0));
        assertEquals(benchmark.getLoc(2), new Point2D(0.0, 2.0));
        assertEquals(benchmark.getLoc(3), new Point2D(1.0, 2.0));
    }
